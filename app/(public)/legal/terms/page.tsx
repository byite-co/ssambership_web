  ...
  return (
    ...
    >
      ...
      <LegalSection title="제7조 (구독)">
        <LegalList
          items={[
            <>구독 요금제는 <strong>라이트(주 4회)</strong>, <strong>스탠다드(주 9회, 추천)</strong>, <strong>프리미엄(공정 사용 정책, FUP)</strong>으로 구성되며, 요금과 주간 질문 한도는 멘토별 설정 및 구독 화면의 안내에 따릅니다.</>,
      ...
      <LegalSection title="제12조 (이용계약의 해지 및 자격 제한)">
        <LegalList
          items={[
            ...
            "탈퇴 시 회원이 업로드한 첨부파일·이미지는 삭제되며, 게시글·질문·답변은 작성자 정보가 익명 처리된 상태로 보존되어 다른 회원의 이용 화면에 계속 표시될 수 있습니다.",
          ]}
        />
      </LegalSection>
